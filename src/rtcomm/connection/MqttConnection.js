...
var MqttConnection = function MqttConnection(config) {
  ...
  //TODO Finalize a better default here.
  this.config.lwtTopic = this.config.lwtTopic || this.config.topicPath+"lwt/";
...
MqttConnection.prototype  = util.RtcommBaseObject.extend((function() {
  ...
  var createMqttMessage = function(message) {
    ...
    if (message && typeof message === 'object') {
      ...
      console.error('createMqttMessage(): invalid message', message);
    }
