 ...
 * @param {string}  [config.lwtTopicName] - Default topic to register with ibmrtc Server
...
var EndpointConnection = function EndpointConnection(config) {
  ...
  var configDefinition = {
    ...
    optional: { credentials : 'object', myTopic: 'string', topicPath: 'string', rtcommTopicName: 'string', userid: 'string', appContext: 'string', secure: 'boolean', lwtTopicName: 'string'},
    defaults: { topicPath: '/rtcomm/', rtcommTopicName: 'management', lwtTopicName: 'lwt'}
  };
    ...
    (function() {
      ...
      return {
        ...
        connect : function(cbSuccess, cbFailure) {
          var epConn = this;
          l('DEBUG') && console.log(this+'.connect() LWT topic: '+ this.getLwtTopic()+ ' message', this.getLwtMessage());
        ...
        getLwtMessage: function() {
          this.private.willMessage =  this.private.willMessage || this.createMessage('LAST_WILL');
          this.private.willMessage.appContext = this.appContext;
          return this.private.willMessage;
        },
        getLwtTopic: function() {
