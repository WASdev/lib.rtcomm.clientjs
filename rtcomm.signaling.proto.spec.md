...
| group           | Declares session can support groups    |
...
| Key                   | Value                                     |
| ----------------------|:-------------------------------------------|
| payload               | {type : String defined in the table below, content : Type specific JSON object} |
...
|    from               | String indicating who sent the message     | 
