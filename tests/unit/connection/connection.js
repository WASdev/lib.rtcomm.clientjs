...
define([
  ...
  var sampleMessage = {
      'START_SESSION':
      {"rtcommVer":"v1.0.0","method":"START_SESSION","protocols":['webrtc', 'chat'], "fromTopic":"/rtcomm/22222222222222222222430","transID":"393415e2-34f3-4748-ed07-1ba121a704bf","appContext":"xxx","sigSessID":"SESS-108b9","toEndpointID":"bpulito",
        ...
        'PRANSWER' :
        {"rtcommVer":"v1.0.0","method":"PRANSWER","protocols":['webrtc','chat'], "fromTopic":'xxx',"transID":"6c528abf-b01d-4528-b8e0-b13b93a46ff6","sigSessID":"d9df3683-fd26-4cc4-8bab-bb94873cda15","payload":{"type":"webrtc", "content":"{type:pranswer, sdp:''}"}},
        'MESSAGE':
        {"rtcommVer":"v1.0.0","method":"ICE_CANDIDATE","fromTopic":"/rtcomm/22222222222222222222430","transID":"6c528abf-b01d-4528-b8e0-b13b93a46ff6","sigSessID":"SESS-108b9",
          ...
          'STOP_SESSION':
          {"rtcommVer":"v1.0.0","method":"STOP_SESSION","fromTopic":"/rtcomm/22222222222222222222430","transID":"393415e2-34f3-4748-ed07-1ba121a704bf","sigSessID":"SESS-108b9", "peerContent":"reason"},
          'SERVICE_QUERY':
          {"rtcommVer":"v1.0.0","method":"SERVICE_QUERY","fromTopic":"xxx","transID":"6c528abf-b01d-4528-b8e0-b13b93a46ff6"}
  };
  ...
  var responseMessage = {
      ...
      'SERVICE_QUERY':
      {"rtcommVer":"v1.0.0","method":"RESPONSE","orig":"SERVICE_QUERY","transID":"6c528abf-b01d-4528-b8e0-b13b93a46ff6", "services": {"iceURL": "stun:host:port,turn:host:port","nodeconnectiontopic":"topic name", "sipconnectiontopic":"topic name"}}
  };
...
//     console.log(msg);
     ...
     assert.equal("v1.0.0", msg.rtcommVer) ;
