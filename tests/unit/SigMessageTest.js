define(["doh/runner","ibm/rtcomm/connection"], function(doh,connection){
  ...
  var sampleMessage = {
      'REGISTER':
      {"rtcommVer":"v0.0.1","method":"REGISTER","fromTopic":"/rtcomm/22222222222222223522540","transID":"de4ab450-8dee-4f9a-96aa-fe70e1d4e232","appContext":"xxx","regTopic":"/rtcomm/22222222222222223522540"},
      'START_SESSION':
      {"rtcommVer":"v0.0.1","method":"START_SESSION","fromTopic":"/rtcomm/22222222222222222222430","transID":"393415e2-34f3-4748-ed07-1ba121a704bf","appContext":"xxx","sigSessID":"SESS-108b9","toEndpointID":"bpulito",
        ...
        'PRANSWER' :
        {"rtcommVer":"v0.0.1","method":"PRANSWER","fromTopic":'xxx',"transID":"6c528abf-b01d-4528-b8e0-b13b93a46ff6","sigSessID":"d9df3683-fd26-4cc4-8bab-bb94873cda15","peerContent":"{type:pranswer, sdp:''"},
        'MESSAGE':
        {"rtcommVer":"v0.0.1","method":"ICE_CANDIDATE","fromTopic":"/rtcomm/22222222222222222222430","transID":"6c528abf-b01d-4528-b8e0-b13b93a46ff6","sigSessID":"SESS-108b9",
  ...
  doh.register("Unit SigMessage Tests", [
                                         ...
                                         {  name: "newMessageTest",
                                           runTest: function(){
                                             ...
                                             doh.assertEqual("v0.0.1", msg.rtcommVer) ;
                                         ...
                                         {  name: "newMessageREGISTER_QUERYTest",
                                           runTest: function(){
                                             var method = 'REGISTER_QUERY';
                                             var msg = connection.MessageFactory.createMessage(method);
                                             console.log(msg);
                                             doh.assertEqual(msg.method, method);
                                             doh.assertTrue(messageValid(msg));
                                         ...
                                         {  name: "CastAStringRegister_query_responseTest",
                                           runTest: function(){
                                             var ssmsg = JSON.parse(responseMessage['REGISTER_QUERY']);
                                             console.log(ssmsg);
                                             var msg = connection.MessageFactory.cast(responseMessage['REGISTER_QUERY']);
                                             console.log(msg);
                                             var not_missing = true;
                                             Object.keys(ssmsg).forEach(function(key){
                                               not_missing = not_missing && msg.hasOwnProperty(key);              
